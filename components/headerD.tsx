...
export default function HeaderC() {
  ...
  const routes = [
    { href: "/auxiliar/citas", label: "Citas" },
    { href: "/auxiliar/calendarios", label: "Calendarios" },
    { href: "/auxiliar/micuenta", label: "Mi cuenta" },
  ]
    ...
    <header className="sticky top-0 z-50 w-full px-[5vw] supports-[backdrop-filter]:bg-white/90 pt-[10px]">
      <div className="flex h-16 items-center justify-start">
        <div className="flex-1">
            <Link href="/auxiliar" className="text-sm text-black font-medium whitespace-nowrap" style={{ textDecoration: "none" }}>
                Mavarez & Román
            </Link>
        </div>
