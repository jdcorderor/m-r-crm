                        ...
                        <div className="flex flex-col items-center justify-center w-full">
                            <div className="w-full bg-gray-50 border border-gray-200 rounded-lg px-8 py-2">
                                <div className="relative top-0">
                                    <Button className="absolute top-3 -left-5 shadow-none rounded-full" onClick={() => router.push("/especialista/pacientes")}>
                                ...
                                <div className="flex flex-col w-full justify-between mt-18 mb-6 text-sm">
