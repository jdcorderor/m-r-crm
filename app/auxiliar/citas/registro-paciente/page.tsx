...
export default function Page() {
    ...
    const [record] = useState<{ antecedentes: string, observaciones: string }>({ antecedentes: "", observaciones: "" });
                ...
                <div className="flex flex-col items-center justify-center w-full">
                    ...
                    <div className="w-full max-w-4xl bg-gray-50 border border-gray-200 rounded-lg my-10">
                        ...
                        <div className="relative top-0">
                            <Button className="absolute top-3 left-2 shadow-none rounded-full"onClick={() => router.push("/auxiliar/citas")}>
