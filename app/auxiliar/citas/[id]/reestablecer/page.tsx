...
export default function Home() {
  ...
  const handleEmailSubmission = async () => {
    const data = {
      email,
      subject: `Reestablecimiento de cita - ${name} ${lastName} | Mavarez & Román`,
      text: `
        <p>Estimado paciente,</p>
        <p>Nos complace informarle que su cita en <strong>Mavarez & Román</strong> ha sido reestablecida y confirmada.</p>
  ...
  // Reservation restoration handler
  const handleConfirmation = async () => {
    ...
    try { 
      ...
      if (response.ok) {
        ...
        console.error("Error al reestablecer la reservación:", error);
        ...
        <div> 
          ...
          <main className="flex justify-center items-center min-h-[80vh]">
            <div className="bg-white w-full max-w-5xl p-10">
              <span className="block text-2xl text-gray-800 font-semibold mb-8 text-center">Reestablecimiento de Citas</span>
